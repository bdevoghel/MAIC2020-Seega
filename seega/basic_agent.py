...
class AI(Player):
    ...
    def successors(self, state):
        ...
        for action in possible_actions:
            next_state, done = SeegaRules.make_move(deepcopy(state), action, self.color.value)
    ...
    def evaluate(self, state):
        ...
        return score + .01 * np.random.random()  # random is to avoid always taking the first move when there is a draw
